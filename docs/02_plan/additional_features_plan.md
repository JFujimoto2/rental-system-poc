...
**詳細:** `docs/06_features/11_settlement.md`
...
**難易度:** 中　**新規テーブル:** 不要　**工数目安:** 中
**詳細:** `docs/06_features/12_reports.md`
...
### Step 13: 承認ワークフロー — 実装済

**対応する既存機能:** 承認受付一覧、承認状況一覧、承認代行委任設定、申請状況一覧
**難易度:** 高　**新規テーブル:** 1（Approval）　**工数目安:** 大
**詳細:** `docs/06_features/13_approval_workflow.md`
