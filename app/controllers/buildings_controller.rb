class BuildingsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @building.save
        format.html { redirect_to @building, notice: "建物を登録しました。" }
  ...
  def update
    respond_to do |format|
      if @building.update(building_params)
        format.html { redirect_to @building, notice: "建物を更新しました。", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to buildings_path, notice: "建物を削除しました。", status: :see_other }
